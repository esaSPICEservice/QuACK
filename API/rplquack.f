      subroutine rplquack( handle, dladsc, point, plid, x, y  )
      implicit none

CCC_ Parameter descriptions

      integer            handle
!     INPUT: Handle of DSK kernel containing plate model, same as in dskx02.

      integer            dladsc(*)
!     INPUT: DLA descriptor of plate model segment, same as in dskx02.
...
CCC_ Set dimensions of QuACK map grid
      nx = 401
      ny = 201
